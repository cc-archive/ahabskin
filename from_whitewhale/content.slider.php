			<ul id="slider">
				...
				<li class="panel">
					...
					<h3>The Biology Project</h3>
					<p>The Biology Project is an <a href="#">interactive online resource for learning biology</a>, developed at the University of Arizona and designed for high school to college-age students. <a class="more_link" href="#">More &raquo;</a></p>
					<ul>
						<li><a href="#">Find online learning resources in biology</a></li>	
						<li><a href="#">Search all learning resources</a></li>
					</ul>
				</li>
				<li class="panel with_image">
				...
				<li class="panel">
					...
					<h3>Log in and help rank OE search results</h3>
					<p>We invite all registered members of the open ed community to <a href="#">login</a> and explore the newly redesigned Community Center. Browse events, post your team’s work, participate in discussion forms, and more. If you aren’t already a member, <a href="#">registration</a> is quick, easy, and free. <a class="more_link" href="#">More &raquo;</a></p>
				</li>
				<li class="panel with_image">
